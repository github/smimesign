...
func (h *testHooks) noop() {
	noop := func(ctx context.Context, query string, args []driver.NamedValue) (context.Context, error) {
		return ctx, nil
	}
...
func (h *testHooks) Before(ctx context.Context, query string, args []driver.NamedValue) (context.Context, error) {
	return h.before(ctx, query, args)
}

func (h *testHooks) After(ctx context.Context, query string, args []driver.NamedValue) (context.Context, error) {
...
func (s *suite) TestHooksExecution(t *testing.T, query string, args ...interface{}) {
	...
	s.hooks.before = func(ctx context.Context, q string, a []driver.NamedValue) (context.Context, error) {
		before = true
		return ctx, nil
	}
	s.hooks.after = func(ctx context.Context, q string, a []driver.NamedValue) (context.Context, error) {
		after = true
		return ctx, nil
	}
...
func (s *suite) testHooksArguments(t *testing.T, query string, args ...interface{}) {
	hook := func(ctx context.Context, q string, a []driver.NamedValue) (context.Context, error) {
		assert.Equal(t, query, q)
		for i, arg := range args {
			assert.Equal(t, arg, a[i].Value)
		}
...
func (s *suite) testHooksErrors(t *testing.T, query string) {
	...
	s.hooks.before = func(ctx context.Context, query string, args []driver.NamedValue) (context.Context, error) {
		return ctx, boom
	}

	s.hooks.after = func(ctx context.Context, query string, args []driver.NamedValue) (context.Context, error) {
